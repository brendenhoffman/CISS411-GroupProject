        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Role = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "Visitor"),
                    Status = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false, defaultValue: "Pending Confirmation"),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Users_Role", "Role IN ('Visitor','Customer','Employee','Admin')");
                    table.CheckConstraint("CK_Users_Status", "Status IN ('Pending Confirmation','Active','Inactive')");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Orders_Status", "Status IN ('Pending','Awaiting Customer Approval','In Process','Ready','Picked Up')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeAssignments_Orders_OrderID",
                        column: x => x.OrderID,
                        principalTable: "Orders",
                        principalColumn: "OrderID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Feedback_RatingRange", "Rating IS NULL OR (Rating BETWEEN 1 AND 5)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DesignApproved = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeAssignments_OrderID_EmployeeID",
                table: "EmployeeAssignments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_OrderID_CustomerID",
                table: "Feedbacks",
